...
<img src="images/ui_style.png" width="300" > <img src="images/ui_style2.png" width="300">
...
class _HistoryListViewState extends State<HistoryListView> {
  ...
  Widget build(BuildContext context) {
    ...
    return ShaderMask(
      shaderCallback: (bound) => _maskingGradient.createShader(bound),
